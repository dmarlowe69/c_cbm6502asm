...
void outline1(FILE *, char, char, char *, char,
              char);                          /* output to tmp or lst file */
...
/*
        macrodef.c
*/
void macro_def(char *, char **, char *,
               int); /* add macro definition to macro table */
...
void insert_symbol(char *, long, int, int,
                   int);           /* insert a new symbol in table */
